...
summarize_prompt = f"You are an expert in aggregating information about the privacy compliance and data protection of an online service. Your job is to summarize the information found in the text into a detailed and informative report. The report should provide a clear overview of the privacy compliance and data protection of the service. The target audience is a non-technical audience that has significant interest in personal privacy and data protection. Make sure to include all information available to you. The current month and year is {time}"
